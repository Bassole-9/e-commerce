...
const Replay = () => {
  const [Tous, setTous] = useState([
    {
      titre: "NCI NEWS",
      image:
        "https://www.positive.news/wp-content/uploads/2019/03/oak-tree-1934897-1500x0-c-default.jpg",
    },
    {
  ...
  return (
    <>
      <div>
        <div className="grandRep">
          <div className="top">
            <div className="floue"></div>
            <h2 className="h2p">Replay</h2>
            <p className="h2s">Accedez aux replay de vos emission préférées</p>
          </div>
          <div className="top2">
            <Categorie />
          </div>
