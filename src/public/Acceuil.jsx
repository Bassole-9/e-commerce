...
import Moment from "../component/AcceuilCompo/momentFort/Moment";
import "./cssPublic/Acceuil.css";
import InfoMag from "../component/AcceuilCompo/infoMag/InfoMag";
import Talk from "../component/AcceuilCompo/talksShow/Talk";
import Divertissement from "../component/AcceuilCompo/divertissements/divert";
import Serie from "../component/AcceuilCompo/serieEtFiction/serie";
import Sport from "../component/AcceuilCompo/Sport/sport";
import Can from "../component/AcceuilCompo/touteLaCan/can";
import Interviews from "../component/AcceuilCompo/interviews/interviews";
import Chronique from "../component/AcceuilCompo/Chronique/chroni";
import { useState } from "react";
import { image11, image13, image17, image40, image41 } from "../assets";
  ...
  const [acceuil, setAcceuil] = useState([
    {
      titre: "NCI NEWS",
      image:
        "https://storage.nci.ci/tv-shows/7fa2fb92-8796-11ee-bd14-0242ac160006/4a9c9aa7-8120-4557-96c4-78a240c2b548.jpg?X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=minioadmin%2F20240812%2Fafrica%2Fs3%2Faws4_request&X-Amz-Date=20240812T222745Z&X-Amz-SignedHeaders=host&X-Amz-Expires=86400&X-Amz-Signature=c6d9bbadbacbf1d49508f47e9d8dca89577d69446d78904aa095537db5ad3ba3",
    },
    {
      titre: "Chante Ton Kiff",
      image:
        "https://storage.nci.ci/tv-shows/9a197984-49e1-11ef-8c62-0242ac12000e/30d1eba2-e066-4064-a0fd-65095f21af3e.jpg?X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=minioadmin%2F20240812%2Fafrica%2Fs3%2Faws4_request&X-Amz-Date=20240812T222745Z&X-Amz-SignedHeaders=host&X-Amz-Expires=86400&X-Amz-Signature=75f3b8551a013d776b5e2e54369ba585344a555ea81b172a52999a9886feee9b",
    },
    {
